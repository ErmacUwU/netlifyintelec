    ...
    <div className="flex items-center justify-center min-h-screen bg-blue-200 p-4">
      <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg p-6">
        <div className="flex flex-col gap-4 items-center">
          ...
          {/* Enlaces de contacto */}
          <div className="p-2 w-full flex flex-wrap items-center justify-center gap-4">
            <Link href="https://wa.me/+526462160078" className="flex items-center justify-center m-2">
              <img src="logos/WSP.png" alt="Whatsapp Logo" className="w-20 h-auto" />
            </Link>
            <Link href="https://mail.google.com/mail/u/1/#inbox?compose=GTvVlcRwRQQnbstJcLdRvRkMdBsSrspztBdZmBVlhpnJjctrwZQfhMKVbJBpcdrDtLCTBcWRlSPDw" className="flex items-center justify-center m-2">
              <img src='logos/gmail.png' alt='Gmail Logo' className='w-20 h-auto'></img>
            </Link>
            <Link href="https://www.facebook.com/Gregoyo55/">
              <img src='logos/facebook.png' className='h-20 w-auto'></img>
            </Link>
          </div>
          ...
          {/* Teléfono */}
          <div className='p-4 w-full flex items-center justify-center flex-col md:flex-row'>
            <img src='logos/phone.png' className='h-16 md:h-24'></img>
            <h2 className='m-3 font-bold text-2xl md:text-3xl'>646-120-56-05</h2>
          </div>
