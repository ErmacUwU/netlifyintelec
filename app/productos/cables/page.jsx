...
const Cables = () => {
  ...
  const catalogos = [
    {
      nombre: "Cables ARGOS",
      url: "http://argoselectrica.com/catalogo-individual/conductores.pdf",
      thumbnail: "https://argoselectrica.com/wp-content/uploads/2024/01/PORTADILLAS-INDIVIDUAL-PAGINA-16-796x1024.jpg"
    },
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Catálogos de Cables</h1>
